...
//24-05 modifica al default.mode
CodeMirror.defaults.mode="prolog";
  //      CodeMirror.defaults.mode="javascript";
    ...
    print: function(src) {
      ...
      CodeMirror.runMode(src, "application/prolog", pre);
//MODIFICA 24-05
   //   CodeMirror.runMode(src, "prolog", pre);
	...
	iframe.contentWindow.print();
      ...
      $.ajax({ url: "/trill_on_swish/bower_components/codemirror/theme/prolog.css",
	       dataType: "text",
	       success: function(data) {
